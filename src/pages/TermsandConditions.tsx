  ...
  return (
    <div className="bg-gray-50 min-h-screen p-24">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Interpretation</h3>
        <p className="text-gray-700 mb-6">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>

        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Definitions</h3>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-6">
          ...
          <li className="mb-2">
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;, or &quot;Our&quot; in this Agreement) refers to XEQT, Silicon Valley, California.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Website</strong> refers to XEQT, accessible from{' '}
            <a href="https://xeqtpro.com" rel="external nofollow noopener" target="_blank" className="text-blue-600 hover:underline">
              https://xeqtpro.com
            </a>
            .
          </li>
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Severability</h3>
        <p className="text-gray-700 mb-6">
          If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law, and the remaining provisions will continue in full force and effect.
        </p>
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Waiver</h3>
        <p className="text-gray-700 mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-6">
          <li className="mb-2">By email: accounts@xeqtpro.com</li>
        </ul>
      </div>
    </div>
  );
