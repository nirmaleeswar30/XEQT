  ...
  return (
    <div className="bg-gray-50 min-h-screen p-24">
      <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Types of Data Collected</h3>
        ...
        <h4 className="text-lg font-medium text-gray-900 mt-4 mb-2">Information from Third-Party Social Media Services</h4>
        <p className="text-gray-700 mb-4">
        ...
        <h4 className="text-lg font-medium text-gray-900 mt-4 mb-2">Tracking Technologies and Cookies</h4>
        <p className="text-gray-700 mb-6">
        ...
        <p className="text-gray-700 mb-6">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul className="list-disc list-inside text-gray-700 mb-6">
          <li className="mb-4">
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-600">Administered by: Us</p>
            <p className="text-gray-600">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
          </li>
          <li className="mb-4">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Use of Your Personal Data</h3>
        ...
        <p className="text-gray-700 mb-6">We may share Your personal information in the following situations:</p>
        <ul className="list-disc list-inside text-gray-700 mb-6">
          <li className="mb-2">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Retention of Your Personal Data</h3>
        <p className="text-gray-700 mb-6">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Transfer of Your Personal Data</h3>
        <p className="text-gray-700 mb-6">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Delete Your Personal Data</h3>
        <p className="text-gray-700 mb-6">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Disclosure of Your Personal Data</h3>
        <h4 className="text-lg font-medium text-gray-900 mt-4 mb-2">Business Transactions</h4>
        <p className="text-gray-700 mb-6">
          If the Company is involved in a merger, acquisition, or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>

        <h4 className="text-lg font-medium text-gray-900 mt-4 mb-2">Law enforcement</h4>
        <p className="text-gray-700 mb-6">
          Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g., a court or a government agency).
        </p>

        <h4 className="text-lg font-medium text-gray-900 mt-4 mb-2">Other legal requirements</h4>
        <p className="text-gray-700 mb-6">
        ...
        <h3 className="text-xl font-medium text-gray-900 mt-6 mb-2">Security of Your Personal Data</h3>
        <p className="text-gray-700 mb-6">
